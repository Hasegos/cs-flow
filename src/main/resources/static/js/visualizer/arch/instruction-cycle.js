...
(function () {
    ...
    function drawTooltip(mx, my, key) {
        ...
        const descW2  = ctx.measureText(desc).width;

        const pad   = 14;
        const tw    = Math.max(titleW2, descW2) + pad * 2;
        const th    = desc ? 60 : 36;
        const W     = GW(), H = GH();
    ...
    window.CsFlow.createVizLifecycle({
        ...
        onPause    : function () { setSpeedBtnsDisabled(false); },
